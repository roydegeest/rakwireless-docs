...
* However if it is not the first time and you want to use the built-in ChirpStack as the LoRa® Server, follow the steps discussed in [Configuring the Gateway](/wisgate/rak7243/quickstart/configure-the-gateway.html#configure-the-gateway) the Gateway section.
...
* Fill in the Gateway ID that we got from the [Configuring the Gateway](/wisgate/rak7243/quickstart/configure-the-gateway.html#configure-the-gateway) section, also called Gateway EUI.
