...
* [Firmware Burning](/wistrio/rak815/quickstart/#device-firmware-setup)
* [Firmware Upgrading](/wistrio/rak815/quickstart/#upgrading-the-firmware)
:::
...
1. Connect the RAK815 SWD interface (refer to the [**datasheet**](/wistrio/rak815/datasheet/) with the J-Link device SWD interface. Then, connect the J-Link device to the PC through the USB port.
