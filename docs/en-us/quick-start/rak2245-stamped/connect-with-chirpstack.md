---
static_root: /assets/images/quick-start-guide/rak2245-stamped/connect-with-chirpstack
---
...
- Fill in the Gateway ID that we got from the last section ([Configuring the Gateway](https://doc.rakwireless.com/rak2245-stamp-edition---lorawan----gateway-concentrator-module/configuring-the-gateway)), also called Geteway EUI.
