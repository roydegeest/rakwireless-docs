...
:::tip 📝 NOTE
 For other settings and detailed documentation for this section, kindly browse the [LoRaWAN Gateway Configuration](../web-management-platform/lorawan-gateway-configuration.html#general-setup) section.
:::
