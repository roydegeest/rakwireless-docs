...
- First, you should have connected your RAK7240 WisGate™ Edge Prime to the router in order to access the internet according to the method which has been introduced in the [Access the Internet](/Product-Categories/WisGate/RAK7240/Quickstart/#access-the-internet) section of this document.
