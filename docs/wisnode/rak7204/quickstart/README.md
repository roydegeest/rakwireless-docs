...
1. [Burning the Bootloader](/wisnode/rak7204/quickstart/#burning-the-bootloader)
2. [Burning the Firmware](/wisnode/rak7204/quickstart/#burning-the-firmware)
:::
...
Depending on which authentication method you want to use ,proceed to either the [OTAA Mode](/wisnode/rak7204/quickstart/#otaa-mode) or [ABP mode](/wisnode/rak7204/quickstart/#abp-mode) section.
