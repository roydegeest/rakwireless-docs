...
* [Upgrading the Firmware](/wisnode/rak612/quickstart/#upgrading-the-firmware)
:::
...
This section walks through the step-by-step discussion on how to customize each key functions of the RAK612 LPWAN Button. For you to enable the message customization, you must at least have the 2.0.2.1.2 firmware version. 

:::tip 📝 NOTE
If your RAK612 LPWAN Button's firmware version is lower than the least version set, please download the latest [RAK612 LPWAN Button Firmware](https://downloads.rakwireless.com/LoRa/RAK612-LoRaButton/Firmware/) and proceed to the [Upgrading the Firmware](/wisnode/rak612/quickstart/#upgrading-the-firmware) section.
:::
...
1. **Connect** your RAK612 LPWAN Button to your Windows PC using a Micro USB cable. Follow the steps in the [Interfacing with RAK612 LPWAN Button](/wisnode/rak612/quickstart/#interfacing-with-rak612-lpwan-button) section if this is the first time you are connecting the device into your WIndows PC. 
...
5. Choose the appropriate port number in the **COM Port** field. Open [Interfacing with RAK612 LPWAN Button](/wisnode/rak612/quickstart/#interfacing-with-rak612-lpwan-button) section to learn on how to choose the appropriate COM Port used. For this demonstration, the COM Port is "**COM3**".
...
* **Command** - this is where you save all of your AT Commands for quick reuse. This is very useful in the [AT Commands for RAK612 LPWAN Button](/wisnode/rak612/quickstart/#at-commands-for-rak612-lpwan-button) section.
