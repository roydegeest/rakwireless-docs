...
1. [Firmware Upgrading](/wisnode/rak7200/quickstart/#upgrading-the-firmware)
:::
...
Congratulations! :tada: You have just successfully interfaced your RAK7200 LPWAN Tracker with your computer! Go on to the next sections to fully configure your RAK7200 LPWAN Tracker.
...
::: tip 📝 NOTE
The default LoRa® work mode is LoRaWAN® 1.0.2, the default LoRa® join mode is OTAA, and the default LoRa® class is Class A.For the full list of AT Commands, head on to [AT Commands for RAK7200 LPWAN Tracker](/wisnode/rak7200/quickstart/#at-commands-for-rak7200-lpwan-tracker).
:::
...
- Choose the appropriate port number in the **COM Port** field. Open the [Interfacing with RAK7200 LPWAN Tracker](/wisnode/rak7200/quickstart/#interfacing-with-rak7200-lpwan-tracker) section to check the appropritate COM Port to be used for the demonstration.
...
2. Download the **RAK Upgrade Tool** from the RAKwireless website [here](https://downloads.rakwireless.com/en/LoRa/RAK612-LoRaButton/Tools/RAK%20LoRaButton%20Upgrade%20Tool%20V1.0.zip) then, open the tool. Again, don't forget to choose the correct port! Open the [Interfacing with RAK7200 LPWAN Tracker](/wisnode/rak7200/quickstart/#interfacing-with-rak7200-lpwan-tracker) to know the appropriate COM Port used.
...
You can also configure your RAK7200 LPWAN Tracker Board using the available AT Commands listed in the [AT Commands for RAK7200 LPWAN Tracker](/wisnode/rak7200/quickstart/#at-commands-for-rak7200-lpwan-tracker) section.