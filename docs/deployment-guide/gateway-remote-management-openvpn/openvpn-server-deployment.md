---
prev: /en-us/deployment-guide/gateway-remote-management-openvpn/
---

# OpenVPN Server Deployment
---

Before proceeding to this tutorial, make sure you already have an AWS EC2 Instance with Ubuntu Server 18.04 LTS running on it. Else, go back to [Amazon Web Service Configurations](/en-us/deployment-guide/amazon-web-service/#amazon-web-service-configurations) section.
